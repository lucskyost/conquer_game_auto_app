...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1157, 813)
        MainWindow.setMinimumSize(QSize(0, 813))
        MainWindow.setMaximumSize(QSize(1157, 813))
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.centralwidget.setEnabled(True)
        self.centralwidget.setMinimumSize(QSize(1157, 770))
        self.centralwidget.setMaximumSize(QSize(1157, 770))
        self.widget = QWidget(self.centralwidget)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(0, 0, 1157, 770))
        self.widget.setMinimumSize(QSize(1157, 770))
        self.widget.setMaximumSize(QSize(1157, 770))
...
"")
        ...
        self.graphicsView.setGeometry(QRect(28, 20, 1101, 727))
...
"")
        ...
        self.graphicsView_2.setGeometry(QRect(30, 22, 256, 725))
...
"")
        ...
        self.avatar_label.setGeometry(QRect(90, 60, 131, 131))
...
"image: url(:/images/images/default_avatar.png);")
        ...
        self.frame.setGeometry(QRect(70, 190, 171, 231))
...
"")
        ...
        self.pushButton_3.setStyleSheet(u"color: #dadbdf;")
        icon2 = QIcon()
        ...
        self.frame_2.setGeometry(QRect(286, 21, 843, 726))
...
"border: none;")
        ...
        self.frame_3.setGeometry(QRect(30, 80, 782, 616))
...
"color: #dadbdf;")
        ...
        self.frame_5.setGeometry(QRect(0, 0, 751, 71))
...
"")
        ...
        self.sortButton.setGeometry(QRect(650, 10, 75, 24))
...
"")
        ...
        self.reloadButton.setGeometry(QRect(560, 10, 75, 24))
...
"")
        ...
        self.sellectAllCheckBox.setGeometry(QRect(19, 55, 76, 20))
        self.importButton = QPushButton(self.frame_5)
        self.importButton.setObjectName(u"importButton")
        self.importButton.setGeometry(QRect(470, 10, 75, 24))
...
"")
        ...
        self.tableWidget.setGeometry(QRect(-5, 80, 751, 251))
...
"")
        ...
        self.frame_6.setGeometry(QRect(-5, 349, 751, 241))
        self.frame_6.setStyleSheet(u"color: #fff")
        self.frame_6.setFrameShape(QFrame.StyledPanel)
        self.frame_6.setFrameShadow(QFrame.Raised)
        self.frame_7 = QFrame(self.frame_6)
        self.frame_7.setObjectName(u"frame_7")
        self.frame_7.setGeometry(QRect(10, 30, 451, 35))
...
"")
        ...
        self.runAutoFileCheckBox = QCheckBox(self.frame_7)
        self.runAutoFileCheckBox.setObjectName(u"runAutoFileCheckBox")
        self.runAutoFileCheckBox.setStyleSheet(u"")

        self.horizontalLayout.addWidget(self.runAutoFileCheckBox)

        self.autoFileLabel = QLabel(self.frame_7)
        self.autoFileLabel.setObjectName(u"autoFileLabel")
        self.autoFileLabel.setStyleSheet(u"border-bottom: 1px solid #338eff;\n"
"            border-left: none;\n"
"            border-right: none;\n"
"")

        self.horizontalLayout.addWidget(self.autoFileLabel)

        self.chosseFileButton = QPushButton(self.frame_7)
        self.chosseFileButton.setObjectName(u"chosseFileButton")
        self.chosseFileButton.setStyleSheet(u"\n"
"\n"
" QPushButton {\n"
"border-radius: 10px; /* \u0110i\u1ec1u ch\u1ec9nh gi\u00e1 tr\u1ecb s\u1ed1 px t\u00f9y theo m\u1ee9c \u0111\u1ed9 bo tr\u00f2n mong mu\u1ed1n */\n"
"\n"
...
"")
        ...
        self.chosseFileButton.setIcon(icon7)

        self.horizontalLayout.addWidget(self.chosseFileButton)
...
"")
        ...
        self.runButton.setGeometry(QRect(650, 30, 75, 24))
...
"")
        ...
        self.closeAllButon.setGeometry(QRect(560, 30, 75, 24))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_3.setText(QCoreApplication.translate("MainWindow", u"VERSION", None))
        ...
        self.runAutoFileCheckBox.setText(QCoreApplication.translate("MainWindow", u"Run auto file", None))
        self.autoFileLabel.setText(QCoreApplication.translate("MainWindow", u"0", None))
        self.chosseFileButton.setText(QCoreApplication.translate("MainWindow", u"Chosse File", None))
